<template>
  <div class="resource">
    <RightSide :rightBoxTitle="'可访问资源'" @closePops="closePops" @reset="reset" @confirm="confirm" :showRightBox="showRightBox">
      <template v-slot:rightSidePopUpWindow>
        <div class="current-name">
          <span>权限集名称</span>
        </div>
        <a-input :style="{ width: '240px' }" :model-value="currentName" disabled />
        <keep-alive>
          <a-tree
            :checkable="true"
...
import { initAllMenu, getSelectPerssions, resetPermissions } from "@/services/api/system-settings";
