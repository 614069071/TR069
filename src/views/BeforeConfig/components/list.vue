  ...
  <a-table :data="colles.value"
    ...
    <template #columns>
      <a-table-column title="序号"
                      data-index="index" />
      <a-table-column title="MAC地址"
                      data-index="username" />
      <a-table-column title="SN"
                      data-index="roleNameZh" />
      <a-table-column title="工单号"
        ...
        <template #cell="{ record }">
          <ControlButtons>
            <span class="primary-color"
                  @click="actionList('detail', record)">详情</span>
            <span class="danger-color"
                  @click="actionList('delete', record)">删除</span>
          </ControlButtons>
        </template>
      </a-table-column>
    </template>
