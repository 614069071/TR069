...
export default {
  ...
  computed: {
    isActive() {
      return (!this.registForm.username || !this.registForm.userPasssword || !this.registForm.confirmUserPasssword || !this.registForm.invitationCode || !this.registForm.verifyCode || this.isCheckFailed) ? false : true
    }
  },
  created() {
    this.dealCode()
